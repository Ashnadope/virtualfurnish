        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 font-body text-sm text-muted-foreground">
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">About Us</Link></li>
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">Contact</Link></li>
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">Careers</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 font-body text-sm text-muted-foreground">
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">Help Center</Link></li>
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">Privacy Policy</Link></li>
                <li><Link href="/landing-page" className="hover:text-primary transition-fast">Terms of Service</Link></li>
              </ul>
            </div>
          </div>
